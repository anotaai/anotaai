...
public class SetorService {
	...
	public ResponseEntity<Setor> create(Setor setor) throws AppException {
		...
		try {
			...
			responseEntity.addMessage(IMessage.ENTIDADE_JA_CADASTRADA, TipoMensagem.ERROR, IMessage.KEEP_ALIVE_TIME_VIEW, setor.getNome());
			...
			responseEntity.getMessages().add(new AnotaaiMessage(IMessage.ENTIDADE_GRAVACAO_SUCESSO,
					TipoMensagem.SUCCESS, IMessage.DEFAULT_TIME_VIEW, setor.getNome()));
		}
	...
	public ResponseEntity<Setor> update(Long id, Setor entity) throws AppException {
		...
		if (entity != null && id != null && id.equals(entity.getId())) {
			...
			message = new AnotaaiMessage(IMessage.ENTIDADE_EDICAO_SUCESSO, TipoMensagem.SUCCESS,
					IMessage.DEFAULT_TIME_VIEW, setor.getNome());
			responseEntity.setMessages(new ArrayList<>());
			responseEntity.getMessages().add(message);
		} else {
			responseEntity.addMessage(IMessage.ILLEGAL_ARGUMENT, TipoMensagem.ERROR,
